...
public final class ActivityAboutMeBinding implements ViewBinding {
  ...
  private ActivityAboutMeBinding(@NonNull ConstraintLayout rootView) {
  ...
  public static ActivityAboutMeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_about_me, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityAboutMeBinding bind(@NonNull View rootView) {
    ...
    return new ActivityAboutMeBinding((ConstraintLayout) rootView);
  }
}
